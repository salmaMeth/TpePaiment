...
public class AdminMenu_MerhantMenuUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.AdminMenu>, ecr.web.app.client.ui.AdminMenu.MerhantMenuUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<i class='icon-bar-chart'></i> <span>Statistics</span>")
    SafeHtml html9();
     
    @Template("<i class='icon-gift'></i> <span>Loyaltys</span>")
    SafeHtml html10();
     
    @Template("<div> <ul class='metro-sidenav clearfix'> <li> <a> <span id='{0}'></span> </a> </li> <li> <a> <span id='{1}'></span></a> </li> <li> <a> <span id='{2}'></span></a>   </li> <li> <a> <span id='{3}'></span></a> </li> <li> <a> <span id='{4}'></span></a> </li> <li> <a> <span id='{5}'></span></a> </li> <li> <a> <span id='{6}'></span></a> </li> <li> <a> <span id='{7}'></span></a> </li> <li> <a> <span id='{8}'></span></a> </li> <li> <a> <span id='{9}'></span></a> </li> </ul> </div>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.AdminMenu owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.AdminMenu owner;
    ...
    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames10 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.onLbl_discountsClick(event);
      }
    };

    public Widgets(final ecr.web.app.client.ui.AdminMenu owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenCss_style style;
    private ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenCss_style get_style() {
      return style;
    }
    private ecr.web.app.client.ui.AdminMenu_MerhantMenuUiBinderImpl_GenCss_style build_style() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      f_HTMLPanel1.addAndReplaceElement(get_lbl_statis(), get_domId8Element().get());
      f_HTMLPanel1.addAndReplaceElement(get_lbl_discounts(), get_domId9Element().get());
    ...
    /**
     * Getter for lbl_statis called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.Button get_lbl_statis() {
      return build_lbl_statis();
    }
    private com.google.gwt.user.client.ui.Button build_lbl_statis() {
      // Creation section.
      final com.google.gwt.user.client.ui.Button lbl_statis = (com.google.gwt.user.client.ui.Button) GWT.create(com.google.gwt.user.client.ui.Button.class);
      // Setup section.
      lbl_statis.setHTML(template_html9().asString());
      lbl_statis.setStyleName("" + get_style().brown() + "");
      lbl_statis.setHeight("80px");
      lbl_statis.setWidth("82px");
      lbl_statis.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames9);
    ...
    /**
     * Getter for lbl_discounts called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.Button get_lbl_discounts() {
      return build_lbl_discounts();
    }
    private com.google.gwt.user.client.ui.Button build_lbl_discounts() {
      // Creation section.
      final com.google.gwt.user.client.ui.Button lbl_discounts = (com.google.gwt.user.client.ui.Button) GWT.create(com.google.gwt.user.client.ui.Button.class);
      // Setup section.
      lbl_discounts.setHTML(template_html10().asString());
      lbl_discounts.setStyleName("" + get_style().orange() + "");
      lbl_discounts.setHeight("80px");
      lbl_discounts.setWidth("82px");
      lbl_discounts.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames10);


      return lbl_discounts;
    }
