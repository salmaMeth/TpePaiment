...
public class TabClients_TabClientsUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.TabClients>, ecr.web.app.client.ui.TabClients.TabClientsUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<i class='icon-user'></i> Clients")
    SafeHtml html1();
     
    @Template("<i class='icon-plus'></i> Add client")
    SafeHtml html2();
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.TabClients owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.TabClients owner;
    ...
    public Widgets(final ecr.web.app.client.ui.TabClients owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.TabClients_TabClientsUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
