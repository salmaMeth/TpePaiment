...
public class UserProfile_UserProfileUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.UserProfile>, ecr.web.app.client.ui.UserProfile.UserProfileUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<span> <i class='icon-off'></i> </span>")
    SafeHtml html1();
     
    @Template("<div Background-Color='#FFFFFF;' class='row-fluid'> <div Background-Color='#FFFFFF;' class='span9'> <div class='profile-info'> <div Background-Color='#FFFFFF;' class='tab-widget'> <ul class='nav nav-tabs' id='myTab1'> <ul class='top-right-toolbar'> <li> <a class='dropdown-toggle blue-violate' data-original-title='Users' data-toggle='dropdown' href='#'> <span id='{0}'></span> </a> </li> </ul> <li class='active'> <a href='#user'> <i class='icon-user'></i> Profile Info </a> </li> </ul> <div class='tab-content'> <div class='tab-pane active' id='user'> <div class='information-container'> <h4>Basic Info</h4> <ul class='media-list'> <li class='media'> <div class='pull-left' href='#'> <div class='media-object'> <span id='{1}'></span> </div> </div> <div class='media-body'> <h4 class='media-heading'>Personal Information</h4> <div class='media'> <div class='pull-left'> <ul class='profile-intro'> <li> <label>First Name:</label> <span id='{2}'></span> <label>PostCode:</label> <span id='{3}'></span> </li> <li> <label>Last Name:</label> <span id='{4}'></span> <label id='{5}'>Default Ip:</label> <span id='{6}'></span> </li> <li> <label>Password:</label> <span id='{7}'></span> <label id='{8}'>Ip Adress1:</label> <span id='{9}'></span></li> <li> <label>Username:</label> <span id='{10}'></span> <label id='{11}'>Ip Adress2:</label> <span id='{12}'></span> </li> <li> <label>Email:</label> <span id='{13}'></span> <label id='{14}'>Ip Adress3:</label> <span id='{15}'></span> </li> <li> <label>Adresse:</label> <span id='{16}'></span> </li> <li> <label>Birthday</label> <span id='{17}'></span> </li> <li> <label>Phone:</label> <span id='{18}'></span> </li> <li> <label>Interest</label> <span id='{19}'></span> </li> </ul> </div> </div> </div> </li> <li class='media'> <a class='pull-right' href='#'> <img alt='64x64' class='media-object' data-src='holder.js/64x64' src='images/administrator.png' style='width: 64px; height: 64px;'> </a> <div class='media-body'> <h4 class='media-heading'><span id='{20}'></span></h4> <span id='{21}'></span> </div> </li> </ul> </div> </div> </div> </div> </div> </div> </div>")
    SafeHtml html2(String arg0, String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8, String arg9, String arg10, String arg11, String arg12, String arg13, String arg14, String arg15, String arg16, String arg17, String arg18, String arg19, String arg20, String arg21);
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.UserProfile owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.UserProfile owner;


    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.onBn_addCloseClick(event);
      }
    };

    public Widgets(final ecr.web.app.client.ui.UserProfile owner) {
      this.owner = owner;
    ...
    SafeHtml template_html2() {
      return template.html2(get_domId0(), get_domId1(), get_domId2(), get_domId3(), get_domId4(), get_domId5(), get_domId6(), get_domId7(), get_domId8(), get_domId9(), get_domId10(), get_domId11(), get_domId12(), get_domId13(), get_domId14(), get_domId15(), get_domId16(), get_domId17(), get_domId18(), get_domId19(), get_domId20(), get_domId21());
    }

    /**
     * Getter for clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay called 1 times. Type: GENERATED_BUNDLE. Build precedence: 1.
     */
    private ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.UserProfile_UserProfileUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_panel() {
      ...
      // Setup section.
      panel.setStyleName("" + get_style().mainPanel() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord52 = UiBinderUtil.attachToDom(panel.getElement());
      ...
      panel.addAndReplaceElement(get_btn_Close(), get_domId0Element().get());
      panel.addAndReplaceElement(get_img_profile(), get_domId1Element().get());
      panel.addAndReplaceElement(get_txt_FirstName(), get_domId2Element().get());
      panel.addAndReplaceElement(get_txt_PostCode(), get_domId3Element().get());
      panel.addAndReplaceElement(get_txt_LastName(), get_domId4Element().get());
      panel.addAndReplaceElement(get_txt_ipadess(), get_domId6Element().get());
      panel.addAndReplaceElement(get_txt_Password(), get_domId7Element().get());
      panel.addAndReplaceElement(get_txt_ipadess1(), get_domId9Element().get());
      panel.addAndReplaceElement(get_txt_Username(), get_domId10Element().get());
      panel.addAndReplaceElement(get_txt_ipadess2(), get_domId12Element().get());
      panel.addAndReplaceElement(get_txt_Email(), get_domId13Element().get());
      panel.addAndReplaceElement(get_txt_ipadess3(), get_domId15Element().get());
      panel.addAndReplaceElement(get_txt_Adresse(), get_domId16Element().get());
      panel.addAndReplaceElement(get_txt_Birthday(), get_domId17Element().get());
      panel.addAndReplaceElement(get_txt_Phone(), get_domId18Element().get());
      panel.addAndReplaceElement(get_txt_Interest(), get_domId19Element().get());
      panel.addAndReplaceElement(get_txt_titleRole(), get_domId20Element().get());
    ...
    /**
     * Getter for btn_Close called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.Button get_btn_Close() {
      return build_btn_Close();
    }
    private com.google.gwt.user.client.ui.Button build_btn_Close() {
      // Creation section.
      final com.google.gwt.user.client.ui.Button btn_Close = (com.google.gwt.user.client.ui.Button) GWT.create(com.google.gwt.user.client.ui.Button.class);
      // Setup section.
      btn_Close.setHTML(template_html1().asString());
      btn_Close.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1);


      owner.btn_Close = btn_Close;
    ...
    private com.google.gwt.dom.client.LabelElement build_lbl_defaultip() {
      // Creation section.
      final com.google.gwt.dom.client.LabelElement lbl_defaultip = new com.google.gwt.uibinder.client.LazyDomElement(get_domId5()).get().cast();
      // Setup section.
    ...
    private com.google.gwt.dom.client.LabelElement build_lbl_ip1() {
      // Creation section.
      final com.google.gwt.dom.client.LabelElement lbl_ip1 = new com.google.gwt.uibinder.client.LazyDomElement(get_domId8()).get().cast();
      // Setup section.
    ...
    private com.google.gwt.dom.client.LabelElement build_lbl_ip2() {
      // Creation section.
      final com.google.gwt.dom.client.LabelElement lbl_ip2 = new com.google.gwt.uibinder.client.LazyDomElement(get_domId11()).get().cast();
      // Setup section.
    ...
    private com.google.gwt.dom.client.LabelElement build_lbl_ip3() {
      // Creation section.
      final com.google.gwt.dom.client.LabelElement lbl_ip3 = new com.google.gwt.uibinder.client.LazyDomElement(get_domId14()).get().cast();
      // Setup section.
    ...
    /**
     * Getter for txt_titleRole called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.Label get_txt_titleRole() {
      return build_txt_titleRole();
    }
    private com.google.gwt.user.client.ui.Label build_txt_titleRole() {
      // Creation section.
      final com.google.gwt.user.client.ui.Label txt_titleRole = (com.google.gwt.user.client.ui.Label) GWT.create(com.google.gwt.user.client.ui.Label.class);
      // Setup section.


      owner.txt_titleRole = txt_titleRole;

      return txt_titleRole;
    }
