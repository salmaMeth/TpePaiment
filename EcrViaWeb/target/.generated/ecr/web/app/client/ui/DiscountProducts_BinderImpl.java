...
public class DiscountProducts_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.DiscountProducts>, ecr.web.app.client.ui.DiscountProducts.Binder {

  interface Template extends SafeHtmlTemplates {
    @Template("<div class='row-fluid'> <div class='span12'> <div class='content-widgets gray'> <div class='widget-head blue clearfix'> <h3 class='pull-left'>Discout Products </h3> </div> <div class='widget-container'> <div class='span6' width='78.718%'> <div class='dataTables_filter' id='DataTables_Table_0_filter'> <label> Search: <span id='{0}'></span> </label> </div> </div> <span id='{1}'></span> </div> </div></div> </div>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.DiscountProducts owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.DiscountProducts owner;
    ...
    public Widgets(final ecr.web.app.client.ui.DiscountProducts owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenCss_style style;
    private ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenCss_style get_style() {
      return style;
    }
    private ecr.web.app.client.ui.DiscountProducts_BinderImpl_GenCss_style build_style() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord51 = UiBinderUtil.attachToDom(container.getElement());
    ...
    private com.google.gwt.user.client.ui.VerticalPanel build_f_VerticalPanel1() {
      ...
      f_VerticalPanel1.add(get_f_DisclosurePanel4());
    ...
    /**
     * Getter for f_DisclosurePanel4 called 1 times. Type: DEFAULT. Build precedence: 3.
     */
    private com.google.gwt.user.client.ui.DisclosurePanel get_f_DisclosurePanel4() {
      return build_f_DisclosurePanel4();
    }
    private com.google.gwt.user.client.ui.DisclosurePanel build_f_DisclosurePanel4() {
      // Creation section.
      final com.google.gwt.user.client.ui.DisclosurePanel f_DisclosurePanel4 = new com.google.gwt.user.client.ui.DisclosurePanel("");
      // Setup section.
      f_DisclosurePanel4.add(get_f_VerticalPanel5());
      f_DisclosurePanel4.setOpen(true);
      f_DisclosurePanel4.setHeight("116px");


      return f_DisclosurePanel4;
    }

    /**
     * Getter for f_VerticalPanel5 called 1 times. Type: DEFAULT. Build precedence: 4.
     */
    ...
    private com.google.gwt.user.client.ui.VerticalPanel build_f_VerticalPanel5() {
      ...
      // Setup section.
      f_VerticalPanel5.add(get_btn_Reset());
      f_VerticalPanel5.setHeight("100px");
      f_VerticalPanel5.setWidth("132px");
