...
public class ConsultRegister_ConsultRegisterUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.ConsultRegister>, ecr.web.app.client.ui.ConsultRegister.ConsultRegisterUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.ConsultRegister owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.ConsultRegister owner;
    ...
    public Widgets(final ecr.web.app.client.ui.ConsultRegister owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.ConsultRegister_ConsultRegisterUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_Container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord13 = UiBinderUtil.attachToDom(Container.getElement());
