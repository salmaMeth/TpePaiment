...
public class MerchantSession_MerchantSessionUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.MerchantSession>, ecr.web.app.client.ui.MerchantSession.MerchantSessionUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.MerchantSession owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.MerchantSession owner;
    ...
    public Widgets(final ecr.web.app.client.ui.MerchantSession owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenCss_style style;
    private ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenCss_style get_style() {
      return style;
    }
    private ecr.web.app.client.ui.MerchantSession_MerchantSessionUiBinderImpl_GenCss_style build_style() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_panel() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord4 = UiBinderUtil.attachToDom(panel.getElement());
      ...
      panel.addAndReplaceElement(get_editprofile(), get_domId3Element().get());
      panel.addAndReplaceElement(get_viewprofile(), get_domId4Element().get());
