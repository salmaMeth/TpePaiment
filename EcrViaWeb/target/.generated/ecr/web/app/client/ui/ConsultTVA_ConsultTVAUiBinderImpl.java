...
public class ConsultTVA_ConsultTVAUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.ConsultTVA>, ecr.web.app.client.ui.ConsultTVA.ConsultTVAUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.ConsultTVA owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.ConsultTVA owner;
    ...
    public Widgets(final ecr.web.app.client.ui.ConsultTVA owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.ConsultTVA_ConsultTVAUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_Container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord45 = UiBinderUtil.attachToDom(Container.getElement());
