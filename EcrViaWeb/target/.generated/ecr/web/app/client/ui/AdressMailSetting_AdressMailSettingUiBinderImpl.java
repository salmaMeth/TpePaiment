...
public class AdressMailSetting_AdressMailSettingUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.AdressMailSetting>, ecr.web.app.client.ui.AdressMailSetting.AdressMailSettingUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<div class='row-fluid'> <div class='widget-container'> <div class='span6'> <div class='dataTables_filter' id='DataTables_Table_0_filter'> </div> </div> </div></div> <span id='{0}'></span>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.AdressMailSetting owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.AdressMailSetting owner;
    ...
    public Widgets(final ecr.web.app.client.ui.AdressMailSetting owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.AdressMailSetting_AdressMailSettingUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_Container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord47 = UiBinderUtil.attachToDom(Container.getElement());
