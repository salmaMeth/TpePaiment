...
public class ConslRayons_Consl_RayonsUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.ConslRayons>, ecr.web.app.client.ui.ConslRayons.Consl_RayonsUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.ConslRayons owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.ConslRayons owner;
    ...
    public Widgets(final ecr.web.app.client.ui.ConslRayons owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.ConslRayons_Consl_RayonsUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_Container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord33 = UiBinderUtil.attachToDom(Container.getElement());
    ...
    private com.google.gwt.user.client.ui.VerticalPanel build_f_VerticalPanel1() {
      ...
      f_VerticalPanel1.add(get_Tab_Rayon());
    ...
    /**
     * Getter for Tab_Rayon called 1 times. Type: DEFAULT. Build precedence: 3.
     */
    private com.google.gwt.user.cellview.client.CellTable get_Tab_Rayon() {
      return build_Tab_Rayon();
    }
    private com.google.gwt.user.cellview.client.CellTable build_Tab_Rayon() {
      // Creation section.
      final com.google.gwt.user.cellview.client.CellTable Tab_Rayon = (com.google.gwt.user.cellview.client.CellTable) GWT.create(com.google.gwt.user.cellview.client.CellTable.class);
      // Setup section.
      Tab_Rayon.addStyleName("" + get_style().editCell() + "");
      Tab_Rayon.setHeight("125px");
      Tab_Rayon.setWidth("945px");
      Tab_Rayon.setPageSize(5);


      owner.Tab_Rayon = Tab_Rayon;
    ...
    private com.google.gwt.user.client.ui.HorizontalPanel build_f_HorizontalPanel2() {
      ...
      f_HorizontalPanel2.add(get_page_rayon());
    ...
    /**
     * Getter for page_rayon called 1 times. Type: DEFAULT. Build precedence: 4.
     */
    private com.google.gwt.user.cellview.client.SimplePager get_page_rayon() {
      return build_page_rayon();
    }
    private com.google.gwt.user.cellview.client.SimplePager build_page_rayon() {
      // Creation section.
      final com.google.gwt.user.cellview.client.SimplePager page_rayon = new com.google.gwt.user.cellview.client.SimplePager(com.google.gwt.user.cellview.client.SimplePager.TextLocation.CENTER);
      // Setup section.
      page_rayon.setWidth("205px");


      owner.page_rayon = page_rayon;
