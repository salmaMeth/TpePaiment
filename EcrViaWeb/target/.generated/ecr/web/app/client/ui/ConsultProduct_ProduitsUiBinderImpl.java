...
public class ConsultProduct_ProduitsUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.ConsultProduct>, ecr.web.app.client.ui.ConsultProduct.ProduitsUiBinder {

  interface Template extends SafeHtmlTemplates {
    @Template("<div class='row-fluid'> <div class='widget-container'> <div class='span6' width='78.718%'> <div class='dataTables_filter' id='DataTables_Table_0_filter'> <label> Search: <span id='{0}'></span> </label> </div> </div> </div></div> <span id='{1}'></span>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.ConsultProduct owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.ConsultProduct owner;
    ...
    public Widgets(final ecr.web.app.client.ui.ConsultProduct owner) {
      this.owner = owner;
     ...
     */
    private ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.ConsultProduct_ProduitsUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_container() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord31 = UiBinderUtil.attachToDom(container.getElement());
