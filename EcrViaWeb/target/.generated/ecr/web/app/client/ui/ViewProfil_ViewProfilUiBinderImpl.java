...
public class ViewProfil_ViewProfilUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, ecr.web.app.client.ui.ViewProfil>, ecr.web.app.client.ui.ViewProfil.ViewProfilUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final ecr.web.app.client.ui.ViewProfil owner) {
   ...
   */
  class Widgets {
    private final ecr.web.app.client.ui.ViewProfil owner;


    public Widgets(final ecr.web.app.client.ui.ViewProfil owner) {
      this.owner = owner;
    ...
    SafeHtml template_html1() {
      return template.html1(get_domId0(), get_domId1(), get_domId2(), get_domId3(), get_domId4(), get_domId5(), get_domId6(), get_domId7(), get_domId8(), get_domId9(), get_domId10(), get_domId11(), get_domId12(), get_domId13(), get_domId14(), get_domId15(), get_domId16(), get_domId17(), get_domId18(), get_domId19(), get_domId20());
    }

    /**
     * Getter for clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay called 1 times. Type: GENERATED_BUNDLE. Build precedence: 1.
     */
    private ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenBundle) GWT.create(ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final ecr.web.app.client.ui.ViewProfil_ViewProfilUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_panel() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord15 = UiBinderUtil.attachToDom(panel.getElement());
      ...
      panel.addAndReplaceElement(get_txt_titleRole(), get_domId19Element().get());
      panel.addAndReplaceElement(get_txt_role(), get_domId20Element().get());
