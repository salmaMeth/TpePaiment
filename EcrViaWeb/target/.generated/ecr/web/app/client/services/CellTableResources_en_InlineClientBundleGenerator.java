...
public class CellTableResources_en_InlineClientBundleGenerator implements ecr.web.app.client.services.CellTableResources {
  private static CellTableResources_en_InlineClientBundleGenerator _instance0 = new CellTableResources_en_InlineClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GPIEPACDED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GPIEPACDDE:hover{color:" + ("#6c6b6b")  + ";}.GPIEPACDPC{background:" + ("#fff")  + ";}.GPIEPACDAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff") ) + (";}.GPIEPACDPD{background:" + ("#f3f7fb")  + ";}.GPIEPACDAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb")  + ";}.GPIEPACDGD{background:" + ("#eee")  + ";}.GPIEPACDHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GPIEPACDJD{background:" + ("#ffc")  + ";}.GPIEPACDKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GPIEPACDBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GPIEPACDCE{border:") + (("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GPIEPACDID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GPIEPACDOD{margin:" + ("30px")  + ";}.GPIEPACDGE{border-collapse:" + ("collapse")  + ";text-align:" + ("right")  + ";width:" + ("100%")  + ";font:" + ("normal"+ " " +"12px"+ "/"+ " " +"150%"+ " " +"Arial"+ ","+ " " +"Helvetica"+ ","+ " " +"sans-serif")  + ";background:" + ("#fff")  + ";overflow:" + ("hidden")  + ";border:" + ("3px"+ " " +"solid"+ " " +"#069")  + ";-webkit-border-radius:" + ("3px") ) + (";-moz-border-radius:" + ("3px")  + ";border-radius:" + ("3px")  + ";}.GPIEPACDED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDFD{background-color:" + ("#069")  + ";color:" + ("white")  + ";font-size:") + (("11px")  + ";border-right:" + ("1px"+ " " +"solid"+ " " +"#0070a8")  + ";border:" + ("none")  + ";}.GPIEPACDOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDDE:hover{color:" + ("#6c6b6b")  + ";}.GPIEPACDPC{background:" + ("#fff")  + ";}.GPIEPACDAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GPIEPACDPD{background:" + ("#f3f7fb")  + ";}.GPIEPACDAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb")  + ";}.GPIEPACDGD{background:" + ("#eee") ) + (";}.GPIEPACDHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GPIEPACDJD{background:" + ("#ffc")  + ";}.GPIEPACDKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GPIEPACDBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GPIEPACDCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GPIEPACDID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GPIEPACDOD{height:" + ((CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getHeight() + "px")  + ";width:") + (((CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getSafeUri().asString() + "\") -" + (CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getLeft() + "px -" + (CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getTop() + "px  no-repeat")  + ";margin:" + ("30px")  + ";}")) : ((".GPIEPACDED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GPIEPACDDE:hover{color:" + ("#6c6b6b")  + ";}.GPIEPACDPC{background:" + ("#fff")  + ";}.GPIEPACDAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff") ) + (";}.GPIEPACDPD{background:" + ("#f3f7fb")  + ";}.GPIEPACDAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb")  + ";}.GPIEPACDGD{background:" + ("#eee")  + ";}.GPIEPACDHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GPIEPACDJD{background:" + ("#ffc")  + ";}.GPIEPACDKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GPIEPACDBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GPIEPACDCE{border:") + (("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GPIEPACDID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GPIEPACDOD{margin:" + ("30px")  + ";}.GPIEPACDGE{border-collapse:" + ("collapse")  + ";text-align:" + ("left")  + ";width:" + ("100%")  + ";font:" + ("normal"+ " " +"12px"+ "/"+ " " +"150%"+ " " +"Arial"+ ","+ " " +"Helvetica"+ ","+ " " +"sans-serif")  + ";background:" + ("#fff")  + ";overflow:" + ("hidden")  + ";border:" + ("3px"+ " " +"solid"+ " " +"#069")  + ";-webkit-border-radius:" + ("3px") ) + (";-moz-border-radius:" + ("3px")  + ";border-radius:" + ("3px")  + ";}.GPIEPACDED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDFD{background-color:" + ("#069")  + ";color:" + ("white")  + ";font-size:") + (("11px")  + ";border-left:" + ("1px"+ " " +"solid"+ " " +"#0070a8")  + ";border:" + ("none")  + ";}.GPIEPACDOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDDE:hover{color:" + ("#6c6b6b")  + ";}.GPIEPACDPC{background:" + ("#fff")  + ";}.GPIEPACDAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GPIEPACDPD{background:" + ("#f3f7fb")  + ";}.GPIEPACDAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb")  + ";}.GPIEPACDGD{background:" + ("#eee") ) + (";}.GPIEPACDHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GPIEPACDJD{background:" + ("#ffc")  + ";}.GPIEPACDKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GPIEPACDBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GPIEPACDCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GPIEPACDID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GPIEPACDOD{height:" + ((CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getHeight() + "px")  + ";width:") + (((CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getSafeUri().asString() + "\") -" + (CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getLeft() + "px -" + (CellTableResources_en_InlineClientBundleGenerator.this.cellTableLoading()).getTop() + "px  no-repeat")  + ";margin:" + ("30px")  + ";}"));
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'cellTableStyle': return this.@ecr.web.app.client.services.CellTableResources::cellTableStyle()();
    }
    return null;
  }-*/;
}
