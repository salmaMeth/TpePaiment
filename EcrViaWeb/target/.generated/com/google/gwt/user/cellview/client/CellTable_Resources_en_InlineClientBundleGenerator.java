  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GPIEPACDED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GPIEPACDDE:hover{color:" + ("#6c6b6b")  + ";}.GPIEPACDPC{background:" + ("#fff")  + ";}.GPIEPACDAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GPIEPACDPD{background:" + ("#f3f7fb")  + ";}.GPIEPACDAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GPIEPACDGD{background:" + ("#eee")  + ";}.GPIEPACDHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GPIEPACDJD{background:" + ("#ffc")  + ";}.GPIEPACDKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GPIEPACDBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GPIEPACDCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GPIEPACDID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GPIEPACDOD{margin:") + (("30px")  + ";}")) : ((".GPIEPACDED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GPIEPACDDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GPIEPACDDE:hover{color:" + ("#6c6b6b")  + ";}.GPIEPACDPC{background:" + ("#fff")  + ";}.GPIEPACDAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GPIEPACDPD{background:" + ("#f3f7fb")  + ";}.GPIEPACDAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GPIEPACDGD{background:" + ("#eee")  + ";}.GPIEPACDHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GPIEPACDJD{background:" + ("#ffc")  + ";}.GPIEPACDKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GPIEPACDBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GPIEPACDCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GPIEPACDID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GPIEPACDOD{margin:") + (("30px")  + ";}"));
      }
