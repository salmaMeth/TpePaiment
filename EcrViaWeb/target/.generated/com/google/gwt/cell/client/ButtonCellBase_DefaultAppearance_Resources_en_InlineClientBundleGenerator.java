...
public class ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator implements com.google.gwt.cell.client.ButtonCellBase.DefaultAppearance.Resources {
  private static ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator _instance0 = new ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator();
  ...
  private void buttonCellBaseStyleInitializer() {
    buttonCellBaseStyle = new com.google.gwt.cell.client.ButtonCellBase.DefaultAppearance.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GPIEPACDA{height:" + ((ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getSafeUri().asString() + "\") -" + (ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getLeft() + "px -" + (ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";background-color:" + ("#f1f1f1")  + ";margin:" + ("0")  + ";padding:" + ("5px"+ " " +"7px")  + ";text-decoration:" + ("none")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";font-size:") + (("small")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#bbb")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#a0a0a0")  + ";border-radius:" + ("5px")  + ";-moz-border-radius:" + ("5px")  + ";}.GPIEPACDF{background:" + ("#666")  + ";color:" + ("white")  + ";}.GPIEPACDE{background:" + ("#940000")  + ";color:" + ("white")  + ";}.GPIEPACDA:hover{border-color:" + ("#939393")  + ";}.GPIEPACDA[disabled]{cursor:" + ("default") ) + (";color:" + ("#888")  + ";}.GPIEPACDA[disabled]:hover{border-color:" + ("#bbb"+ " " +"#bbb"+ " " +"#a0a0a0")  + ";}.GPIEPACDG{border:" + ("1px"+ " " +"inset"+ " " +"#ccc")  + ";}.GPIEPACDB{border-top-right-radius:" + ("0")  + ";border-bottom-right-radius:" + ("0")  + ";-moz-border-radius-topleft:" + ("0")  + ";-moz-border-radius-bottomleft:" + ("0")  + ";}.GPIEPACDC{border-left:" + ("none")  + ";border-top-left-radius:" + ("0")  + ";border-bottom-left-radius:" + ("0")  + ";-moz-border-radius-topright:") + (("0")  + ";-moz-border-radius-bottomright:" + ("0")  + ";}")) : ((".GPIEPACDA{height:" + ((ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getSafeUri().asString() + "\") -" + (ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getLeft() + "px -" + (ButtonCellBase_DefaultAppearance_Resources_en_InlineClientBundleGenerator.this.buttonCellBaseBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";background-color:" + ("#f1f1f1")  + ";margin:" + ("0")  + ";padding:" + ("5px"+ " " +"7px")  + ";text-decoration:" + ("none")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";font-size:") + (("small")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#bbb")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#a0a0a0")  + ";border-radius:" + ("5px")  + ";-moz-border-radius:" + ("5px")  + ";}.GPIEPACDF{background:" + ("#666")  + ";color:" + ("white")  + ";}.GPIEPACDE{background:" + ("#940000")  + ";color:" + ("white")  + ";}.GPIEPACDA:hover{border-color:" + ("#939393")  + ";}.GPIEPACDA[disabled]{cursor:" + ("default") ) + (";color:" + ("#888")  + ";}.GPIEPACDA[disabled]:hover{border-color:" + ("#bbb"+ " " +"#bbb"+ " " +"#a0a0a0")  + ";}.GPIEPACDG{border:" + ("1px"+ " " +"inset"+ " " +"#ccc")  + ";}.GPIEPACDB{border-top-left-radius:" + ("0")  + ";border-bottom-left-radius:" + ("0")  + ";-moz-border-radius-topleft:" + ("0")  + ";-moz-border-radius-bottomleft:" + ("0")  + ";}.GPIEPACDC{border-right:" + ("none")  + ";border-top-right-radius:" + ("0")  + ";border-bottom-right-radius:" + ("0")  + ";-moz-border-radius-topright:") + (("0")  + ";-moz-border-radius-bottomright:" + ("0")  + ";}"));
      }
