...
public class ViewProfil extends Composite {
	 @UiField
	...
	private static ViewProfilUiBinder uiBinder = GWT
			.create(ViewProfilUiBinder.class);

	interface ViewProfilUiBinder extends UiBinder<Widget, ViewProfil> {
	}

	public ViewProfil(String resp) {
