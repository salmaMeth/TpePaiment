 ...
 */
@Service("Refondtransaction")

public class RefondsServiceImp extends RemoteServiceServlet implements RefondsService {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private static Logger log = LoggerFactory.getLogger(RefondsServiceImp.class);
	...
	public TxnResponseDTO Refondtransaction(String termIpAdr,TransactionDataIn data) {
			...
			tranReq = new DoTransactionReq();
				...
				tranReq.setReqTransactionType(TxnType.REFUND);
